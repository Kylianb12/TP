...
class TestQCM(unittest.TestCase):
    def test_quiz_score(self):
        ...
        question1 = Question("Quelle est la capitale de la Suisse ?", ["Berne", "Amsterdam", "Budapest"], "Berne")
        question2 = Question("Quelle est la capitale du Portugal ?", ["Porto", "Lisbonne", "Athènes"], "Lisbonne")
